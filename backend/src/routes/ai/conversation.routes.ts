...
import { listConversations, getConversation, saveConversation, patchConversation, deleteConversation, getSystemPromptByDigest } from '../../controllers/aiController.js';
...
router.get('/api/ai/system-prompt/:digest', getSystemPromptByDigest);
